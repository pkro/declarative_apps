...
export class IOContainer {
  ...
  static of(fn) {
    return R.compose(
      ...
      R.when(
        // if first argument is satisfied, return second argument, otherwise rettun as is
        R.complement(R.is(Function)), // complement = NOT -> if fn is not a function
        R.always(() => fn) // return a function that returns the value fn
      )
    )(fn);
  }

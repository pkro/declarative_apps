...
// sortByOrder :: [{k:v}] -> [{k:v}]
const sortByOrder = sort(ascend(R.prop("order")));

// groupByProp :: Str -> [Obj] -> [[Obj]]
export const groupByProp = (key) =>
  compose(groupWith(R.eqProps(key)), sortBy(R.prop(key)));
...
export const setActiveAt = (pos2dPath) =>
  set(lensPath([...pos2dPath, "active"]), true);

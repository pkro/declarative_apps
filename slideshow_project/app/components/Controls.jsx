...
const right = o(set(lensIndex(1), 0), over(lensIndex(0), inc));

// left :: [Int, Int] -> [Int, Int]
const left = o(set(lensIndex(1), 0), over(lensIndex(0), dec));
  ...
  return (
    <aside className="slide-controls">
      ...
      <button
        className="btn btn-lg btn-info btn-outline"
        onclick={() =>
          changeSetting("fullscreen", !R.prop("fullscreen", settings))
        }
      >
        <i
          className={`fa fa-${
